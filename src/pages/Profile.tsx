...
const Profile: React.FC = () => {
  ...
  const completedFieldsCount = completionFields.filter(field => {
    ...
    // Safely check for travelDocuments and its length directly
    if (field === "Travel document" && profileData.travelDocuments && Array.isArray(profileData.travelDocuments) && profileData.travelDocuments.length > 0) return true;
